...
def main(args):
    ...
    # Sample images:
    samples = diffusion.generate_samples(model=model.forward_with_cfg,
                                         shape=z.shape,
                                         noise=z,
                                         clip_denoised=False,
                                         denoised_fn=None,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", type=str, default='/mnt/data2/zhanghaoyu/Codeprojects/Gene/DiT/ckpt/minist/newest.pt',
